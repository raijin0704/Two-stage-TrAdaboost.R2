...
class SimpleTrAdaBoostR2:
    ...
    def fit(self, X, y, sample_weight=None):
        ...
        for iboost in range(self.n_estimators): # this for loop is sequential and does not support parallel(revison is needed if making parallel)
            # Boosting step
            sample_weight, estimator_weight, estimator_error = self._simple_TrAdaboostR2(
                    iboost,
                    X, y,
                    sample_weight)
            # Early termination
    ...
    def _simple_TrAdaboostR2(self, iboost, X, y, sample_weight):
